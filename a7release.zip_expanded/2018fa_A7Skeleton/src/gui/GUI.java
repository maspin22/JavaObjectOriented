...
public class GUI extends JFrame {
    ...
    protected MazePanel mazePanel;            			//The panel for generating and drawing the maze
    protected DiverSprite diver;        				//The panel for updating and drawing the diver
    protected OptionsPanel options;           			//The panel for showing stats / displaying options
    ...
    private static final double INFO_SIZE= 0.58;/*was 0.5*/    		//How much of the screen should the info make up?
    
    /** Constructor: a new display for sewer system with the diver at (diverRow, diverCol)
     * using random number seed seed and overseen by GameState gs. */
    ...
    /** Move the diver on the GUI to destination dest.
     *  Note : This blocks until the diver has moved.
    ...
    /** The main program. Run find-ring and get-out on a random seed, except for:
     * If there is an argument -s <seed>, run on that seed. */
    public static void main(String[] args) {
        ...
        GameState.runNewGame(seed, true, new DiverMax());
    }
}
